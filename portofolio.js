...
// ===== CONSOLE MESSAGE =====
console.log('%c👋 Hello! Welcome to my portfolio!', 'color: #00ff88; font-size: 20px; font-weight: bold;');
console.log('%cBuilt with ❤️ by Obinna Egwuatu (Oracle)', 'color: #00d4ff; font-size: 14px;');
